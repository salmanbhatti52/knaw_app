      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            color: widget.postDetail!.isViewed!
            ...
            children: [
              ...
              Wrap(spacing: 0, runSpacing: 0, children: [
                ...
                ExpandableText(
                  ...
                  linkStyle: openSansRegular.copyWith(
                      fontSize: Dimensions.fontSizeSmall, color: Colors.amber),
                ),
                // RichText(
                //   maxLines:3,
                //   text: TextSpan(
                ...
                child: Row(
                  children: [
                    ...
                    VerticalTile(
                      ...
                      isBlack: true,
                      onTap: () => Get.bottomSheet(CommentScreen(
                        postDetail: widget.postDetail,
                      )),
                    ),
                    Expanded(child: Container()),
                    VerticalTile(
                      ...
                      title: "Link",
                      onTap: () =>
                          _launchURL(widget.postDetail!.externalLink ?? ''),
                    ),
                    Expanded(child: Container()),
                    VerticalTile(
                        icon: Images.share,
